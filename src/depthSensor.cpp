...
class depth{
    public:
        ros::NodeHandle n2;
        ros::Publisher pub = n2.advertise<geometry_msgs::Point>("/depthSensor/points",1000);
...
int main(int argc, char **argv){
	...
	ros::NodeHandle n;
    depth depth_object;
	ros::Subscriber sub = n.subscribe("/camera/depth/points",1000,&depth::depth_cb,&depth_object);
